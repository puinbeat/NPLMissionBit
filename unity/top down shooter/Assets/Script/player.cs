...
public class player : MonoBehaviour {
	...
	void FixedUpdate () {
		...
		// rotation
		mousePos = new Vector3 (0, Input.mousePosition.y, 0);
		transform.LookAt (mousePos);
//		transform.eulerAngles = new Vector3 (0, mousePos.y, 0);

//		var distance = (transform.position.y - Camera.main.transform.position.y);
//		position = new Vector3(Input.mousePosition.x, Input.mousePosition.y, distance) * 0.8f;
